...
public class JDocumentPanel extends javax.swing.JPanel {
     ...
     */
    public JDocumentPanel(DiaryApp d, Clipboard c) {
        initComponents();
        this.c = c;
        this.d = d;
        jButton8.hide();
    ...
    public JDocumentPanel(DiaryApp d, Clipboard c, File f) {
        initComponents();
        this.c = c;
        this.d = d;
        this.f = f;
    ...
    public static void main(String[] args) {
        JFrame j = new JFrame();
        j.add(new JDocumentPanel(new DiaryApp(), new Clipboard()));
        j.setVisible(true);
    }
    boolean saved;
    ...
    private javax.swing.JPopupMenu pastePopup;
    private javax.swing.JMenuItem saveAll;
    private javax.swing.JMenuItem saveAs;
    private javax.swing.JPopupMenu savePopup;
